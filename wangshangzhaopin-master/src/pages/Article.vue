  ...
  <div class="article">
    ...
    <div class="article_table" v-loading="loading">
      ...
      >
        ...
        <el-table-column prop="companyFullname" label="招聘企业"></el-table-column>
        <el-table-column prop="city" label="城市"></el-table-column>
        <el-table-column prop="salaryText" label="薪资"></el-table-column>
        <el-table-column prop="activeTime" label="发布时间"></el-table-column>
        <el-table-column prop="workerNumber" label="公司规模"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="{row}">
            ...
            <i class="fa fa-pencil" @click="openModel(row)"></i>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    batchDeleteArticle() {
      this.$confirm("此操作将永久删除信息, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          let url = "/api/api/sss/deletemanysss";
